...
class AccountController extends AppBaseController
{
     ...
     * Update appleid for payout field in accounts table
    ...
    public function apply_for_payout(Request $request)
    {
        ...
        if (Auth::user()->id != $account->user_id) {
            Flash::error('You connot perform this operation on an account that is not yours');
     ...
     * Update appleid for payout field in accounts table to 0
    ...
    public function mark_as_paid(Request $request)
    {
        ...
        if (Auth::user()->role_id > 2) {
            Flash::error('You connot perform this operation if you are not an admin');
